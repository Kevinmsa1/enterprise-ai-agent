...
| Resource | Link |
|---|---|
| **Live Demo** | [Open the application](https://enterprise-ai-agent-kevinmsa.streamlit.app/) |
| **GitHub Repository** | [View the source code](https://github.com/Kevinmsa1/enterprise-ai-agent) |
